...
class Selftest extends Controller {
	...
	public function test_8() {
		$fail = 0;
		$test_image = getcwd() . '/img/footer.png';
		$files = array('tmp_name' => $test_image, 'name' => 'test.png', 'size' => filesize($test_image), 'error' => 0, 'type' => 'image/jpeg');

		if(!file_exists($test_image)) {
			$fail = 1;
			$this->errors[8] .= 'Essential rob imagery is missing (img/footer.png). ';
		}
