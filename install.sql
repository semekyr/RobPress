...
(1, 'text', 'name', 'RobPress', 'Blog Name'),
...
CREATE TABLE `cookies` (
  ...
  `cookie_name` VARCHAR(255) NOT NULL,          -- Name of the cookie
  `cookie_value` TEXT NOT NULL,                 -- Value of the cookie
  `expires_at` DATETIME DEFAULT NULL,           -- Expiration time
  ...
  KEY `user_id` (`user_id`)                     -- Index on user_id
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
